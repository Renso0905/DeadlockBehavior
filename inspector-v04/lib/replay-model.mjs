...
export async function buildReplayModel({outputRoot,replayName,cacheRoot=null,force=false}) {
  ...
  const model={
    ...
    troopers,
    flyingSouls:runtimeFlyingSouls?.status==='RUNTIME_FLYING_SOUL_PRODUCTION_V01_READY'?{status:runtimeFlyingSouls.status,authorityLayer:'extended',summary:runtimeFlyingSouls.summary,counts:runtimeFlyingSouls.counts,semanticScope:runtimeFlyingSouls.semanticScope,validation:runtimeFlyingSouls.validation,source:'runtime_flying_soul_production_v01.json'}:null,
