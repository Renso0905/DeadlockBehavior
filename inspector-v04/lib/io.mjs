...
export async function sourceHealth(replayDir) {
  const defs = [
    ...
    ['runtime_flying_souls','runtime_flying_soul_production_v01.json','A','Extended A: conservative source-linked flying-soul episode summary'],
    ['runtime_flying_soul_events','runtime_flying_soul_events_v01.jsonl','A','Extended A: mutually unique Trooper link and direct attackable-time evidence'],
