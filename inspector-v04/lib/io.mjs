...
export async function sourceHealth(replayDir) {
  const defs = [
    ...
    ['runtime_trooper_deaths','runtime_trooper_deaths_production_v01.json','A','Extended A: replicated Trooper death and direct raw context summary'],
    ['runtime_trooper_death_events','runtime_trooper_death_events_v01.jsonl','A','Extended A: authoritative Trooper death timing, subclass, team, and lane evidence'],
    ['runtime_flying_souls','runtime_flying_soul_production_v01.json','A','Extended A: conservative source-linked flying-soul lifecycle and direct damage-observation summary'],
    ['runtime_flying_soul_events','runtime_flying_soul_events_v01.jsonl','A','Extended A: mutually unique Trooper link, attackable-time, and player-attributed damage-message evidence'],
