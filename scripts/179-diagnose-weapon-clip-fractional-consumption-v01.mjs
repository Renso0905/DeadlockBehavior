...
const VERSION =
  'WEAPON_CLIP_FRACTIONAL_CONSUMPTION_DIAGNOSTIC_V01';
...
const PATHS = {
  ...
  output: resolve(
    'output',
    'test',
    'weapon_clip_fractional_consumption_diagnostic_v01.json',
  ),
};
...
const EXPECTED_ZERO = EXPECTED_COMPARABLE - EXPECTED_TRANSFORMED_ALIGNED;
...
const checks = {
  ...
  zeroWholeBaselineRecovered: check(
    pooled.whole.zero,
    EXPECTED_ZERO,
    pooled.whole.zero === EXPECTED_ZERO,
  ),
...
const result = {
  ...
  status:
    integrityPass
      ? 'WEAPON_CLIP_FRACTIONAL_CONSUMPTION_DIAGNOSTIC_V01_READY_FOR_INTERPRETATION'
      : 'WEAPON_CLIP_FRACTIONAL_CONSUMPTION_DIAGNOSTIC_V01_INTEGRITY_FAILURE',
...
function print(result) {
  console.log('');
  console.log('========================================================');
  console.log('WEAPON CLIP FRACTIONAL CONSUMPTION DIAGNOSTIC V0.1');
  console.log('========================================================');
  console.log('');
