...
const VERSION = 'RUNTIME_ITEM_OWNERSHIP_CROSS_REPLAY_REPLICATION_V01';
...
const OUTPUT_PATH = resolve('output', 'cross_replay', 'runtime_item_ownership_cross_replay_replication_v01.json');
...
console.log('');
console.log('========================================================');
console.log('RUNTIME ITEM OWNERSHIP CROSS-REPLAY REPLICATION V0.1');
console.log('========================================================');
console.log('');
...
const status = validationPass
  ? 'RUNTIME_ITEM_OWNERSHIP_V01_STRONGLY_REPLICATED_ACROSS_INDEPENDENT_REPLAYS'
  : 'RUNTIME_ITEM_OWNERSHIP_V01_REPLICATION_REQUIRES_DIAGNOSIS';
