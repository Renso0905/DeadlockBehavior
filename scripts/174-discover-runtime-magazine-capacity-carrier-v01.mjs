...
const VERSION =
  'RUNTIME_MAGAZINE_CAPACITY_CARRIER_DISCOVERY_V01';
...
if (replayName !== 'test') {
  throw new Error(
    [
      'Script174 is discovery-only and must run on test.',
...
const PATHS = {
  ...
  output: resolve(
    'output',
    replayName,
    'runtime_magazine_capacity_carrier_discovery_v01.json',
  ),
};
      ...
      ? (
        evaluation.classification
          === 'RELOAD_EXIT_CLIP_PLATEAU_IS_STRONG_RUNTIME_MAGAZINE_CAPACITY_CANDIDATE'
            ? 'RUNTIME_MAGAZINE_CAPACITY_CARRIER_DISCOVERY_V01_READY_FOR_SEMANTIC_VALIDATION'
            : 'RUNTIME_MAGAZINE_CAPACITY_CARRIER_DISCOVERY_V01_REQUIRES_DIAGNOSIS'
      )
      : 'RUNTIME_MAGAZINE_CAPACITY_CARRIER_DISCOVERY_V01_INTEGRITY_FAILURE',
...
function print(result) {
  ...
  console.log(
    'RUNTIME MAGAZINE CAPACITY CARRIER DISCOVERY V0.1',
  );
  console.log(
    '========================================================',
  );
